...
//public interface IUser<TUserId>: IActionDate
//{
...
public interface IAction{DateTime ActionDate { get; set; } }

public interface IAction<TAction>: IAction
    where TAction : Enum
{
    TAction Action { get; set; }
}

public interface IAction<TAction, TUserId, TUser>:IAction<TUserId, TUser>,IAction<TAction>
...
class Foo2 : IAction, IUser<int,User>, IParent<int,Foo>,IEntity<int>
{
