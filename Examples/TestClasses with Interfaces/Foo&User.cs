...
namespace BaikalNetHub.NET.EF.Onion.Examples.TestClasses.WithInterfaces;
...
public partial class Foo: IEntity<Guid>, IChild<Bar>, ICreatedBy<User>
    ...
    public ICollection<Bar> Children { get; set; }
...
{
    public Guid Id { get; set; }
    public ICollection<ManyMany> Children { get; set; }
    public DateTime CreationDate { get; set; }
    public int CreatedByUserId { get; set; }
    public User CreatedByUser { get; set; }
